...
function ConfirmationContent() {
  ...
  useEffect(() => {
    // Pixel Facebook - Event "Schedule" pour conversion Calendly
    fbq.event('Schedule', {
      content_name: 'RDV Calendly Confirmé - Facebook Ads',
      value: 100,
      currency: 'EUR'
    })

    // Event custom pour tracking supplémentaire
    fbq.customEvent('call_booked', {
      content_name: 'RDV Calendly Confirmé - Experts Comptables',
      value: 100,
      currency: 'EUR'
    })

    // Marquer call_booked = true dans Supabase si session_id présent
    if (sessionId) {
